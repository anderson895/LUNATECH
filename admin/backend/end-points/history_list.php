...
$search_all_history = $db->search_all_history($search, $branch_id, $limit, $offset);
$totalRecords = $db->count_all_history($search, $branch_id);
...
if ($search_all_history && $search_all_history->num_rows > 0) {
    ...
    $output .= "<tr><td colspan='7' class='p-4 text-center text-gray-500'>No record found.</td></tr>";
}
