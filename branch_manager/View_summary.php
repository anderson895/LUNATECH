...
// Ensure 'branch_address' exists in the first record
$branch_address = isset($purchase_record[0]['branch_address']) ? $purchase_record[0]['branch_address'] : 'Address not available';
...
<div id="export-content">
    ...
    <div class="text-center mb-4">
        ...
        <div class="text-gray-700"><?= ucfirst($On_Session[0]['branch_name']) ?></div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                <td class="border border-gray-400 p-2">
                    <?= date('F j, Y - g:i A', strtotime($item['purchase_date'])) ?>
                </td>
...
$(document).ready(function () {
    $("#exportExcel").click(function () {
        ...
        let ws_data = [
            ...
            ["Date","Model", "Price Sold", "Payment", "Remarks"]
        ];
