...
if ($search_all_history && $search_all_history->num_rows > 0) {
    while ($history = $search_all_history->fetch_assoc()) {
        ...
        $totalUnitSold = htmlspecialchars($history['total_item_unit_sold']);
        ...
        <td class='p-3 text-center font-semibold text-green-600'>" . $totalUnitSold . " " . ($totalUnitSold > 1 ? "pcs" : "pc") . "</td>
            ...
            <td class='p-3 text-center'>
                <div class='flex justify-center gap-2'>
                    ...
                    <a href='view_history?invoice=" . urlencode($invoice) . "&purchase_id=" . urlencode($id) . "'> 
                        ...
                        <button class='archivedTransaction bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded flex items-center gap-1 transition' data-purchase_id=" . urlencode($id) . ">
                            <span class='material-icons'>delete_outline</span> <span>Archived</span>
                        </button>
